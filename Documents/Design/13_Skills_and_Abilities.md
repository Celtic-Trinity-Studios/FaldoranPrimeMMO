...
- **Agility:** Coordination, balance, and speed.
- **Vitality:** Physical health and resilience.
- **Intelligence:** Capacity for logic, memory, and learning.
- **Spirit:** Mental fortitude, willpower, and crystal resonance efficiency.
- **Stamina:** Enduring physical exertion over time.
- **Strength:** Raw physical power and muscle mass.
...
- **Archery:** The use of shortbows, longbows, and composite bows.
...
- **Alchemy:** Creating potions, oils, and alchemical fires.
- **Armor Forging:** Crafting mail, plate, and reinforced gear.
- **Weapon Forging:** The art of the bladesmith and weaponsmith.
- **Blacksmithing:** Creating tools, nails, and general ironware.
- **Stonemasonry:** Working with stone for building and carving.
- **Carpentry:** Construction and crafting with wood.
- **Leatherworking:** Preparing hides and crafting leather goods.
- **Tailoring:** Turning textiles into clothing and padding.
- **Jewel-crafting:** Working with precious metals and gems.
- **Shipwrighting:** Construction of boats and sea-faring vessels.
- **Cooking:** Preparing meals for sustenance and buffs.
- **Brewing:** The art of crafting ales, wines, and spirits.
- **Siege Engineering:** Designing and building engines of war.
- **Scribing:** Transcribing scrolls, maps, and magical documents.
...
## ✅ Artistry (Design)
The aesthetic finishing of goods and the creation of beauty.
- **Color Matching:** Harmonizing pigments and dyes.
- **Dyeing:** Applying color to fabrics and leathers.
...
- **Drafting:** Sketching blueprints and construction plans.
- **Structural Integrity:** Understanding load-bearing and stability.
- **Fortification Design:** Specialist knowledge in walls, gates, and moats.
- **Vaulting & Arches:** Mastery of complex roof and ceiling supports.
- **Timber Framing:** Layout of heavy wooden support structures.
...
- **Anatomy:** Detailed knowledge of organic structures.
- **Beast Lore:** Understanding habits and weaknesses of animals.
- **Abomination Lore:** Knowledge of mutated and unnatural creatures.
...
- **Pyromancy:** The art of fire and heat.
- **Cryomancy:** The art of frost and cold.
- **Fulgurancy:** The art of lightning and energy.
- **Geomancy:** Manipulation of earth, stone, and metal.
- **Hydromancy:** Command over water and liquids.
- **Aeromancy:** Mastery of wind and air.
- **Necromancy:** The manipulation of life force and the dead.
- **Illusion:** The weaving of light and shadow to deceive.
- **Conjuration:** Summoning creatures and objects from the void.
- **Abjuration:** Creating shields, wards, and protective barriers.
- **Enchanting:** Imbuing items with magical properties.
- **Runic Inscription:** Carving power into objects via ancient scripts.
...
- **Translocation:** The art of teleportation and portals.

## ✅ Extraction (Mining)
Tearing wealth from the mountains and the earth.
- **Metalsmithing Lore:** Knowledge of ore quality and properties.
...
- **Resource Gathering:** General efficiency in bulk extraction.

## ✅ Animal Husbandry
The breeding, taming, and management of Faldoran's diverse fauna.
- **Beast Taming:** Domesticating wild creatures for labor or travel.
- **Selective Breeding:** Matching parents to enhance specific traits (Speed, Carry, HP).
- **Veterinary Medicine:** Diagnosing and treating animal illnesses or injuries.
...
- **Ancient History:** Knowledge of the ages before the current.
- **Astrology:** Reading the stars for navigation and omen.
- **Herbology:** Classification and properties of plants.
- **Navigation:** Charting courses by sea and star.
- **Nautical Systems:** Understanding the rigging and handling of ships.
- **Master Mariner:** Advanced piloting of maritime vessels.
- **Theology:** Study of religions and the divine.
- **Scholar:** General academic proficiency and research.
- **Cryptography:** The art of making and breaking codes.
- **Bloodline Lore:** Understanding genetics and ancestry.
